        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <ul className="text-sm">
              ...
              <li><a href="/search" className="hover:text-blue-300">Find a Doctor</a></li>
              <li><a href="/dashboard" className="hover:text-blue-300">Patient Dashboard</a></li>
            </ul>
          </div>
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            <h4 className="text-lg font-semibold mb-2">Contact</h4>
            <p className="text-sm">Email: support@careable.com</p>
